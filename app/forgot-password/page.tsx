...
import { Mail, ArrowLeft, AlertCircle, CheckCircle, TrendingUp, Sun, Moon, Send } from 'lucide-react'
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 pb-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-lg">
          <div ref={formRef} id="form" className={`backdrop-blur-xl bg-white/10 dark:bg-black/20 border border-white/20 dark:border-white/10 rounded-xl p-6 shadow-2xl transition-all duration-1000 delay-300 ${visibleElements.has('form') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
              <div className="md:col-span-2 space-y-2">
                ...
                <Input
                  ...
                  required
                  className="h-10 rounded-lg border-gray-200/50 dark:border-gray-700/50 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm focus:border-blue-500 focus:ring-blue-500 transition-all duration-200"
                />
              </div>
              ...
              <div className="md:col-span-3">
                <Button
                  ...
                  variant="outline"
                  onClick={() => router.push('/')}
                  className="w-full h-10 rounded-lg border-gray-200/50 dark:border-gray-700/50 bg-white/30 dark:bg-gray-800/30 backdrop-blur-sm hover:bg-white/50 dark:hover:bg-gray-800/50 transition-all duration-200"
                >
                  <ArrowLeft className="h-4 w-4 mr-2" />
                  Retour à la connexion
                </Button>
            ...
            <div className="mt-4 p-3 bg-blue-50/60 dark:bg-blue-900/30 backdrop-blur-sm rounded-lg border border-blue-200/30 dark:border-blue-800/30">
              <p className="text-xs text-blue-700 dark:text-blue-300">
                <strong>Note :</strong> Seuls les utilisateurs invités et enregistrés peuvent réinitialiser leur mot de passe.
              </p>
            </div>
          </div>
        </div>
